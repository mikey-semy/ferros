...
//! - [`thread`] (M4d) — кооперативные потоки ядра с переключением контекста: отдельный
//!   стек на поток и явный [`thread::yield_now`]. Фундамент вытесняющей многозадачности.
//!
//! Вытеснение по таймеру (фаза 2) встанет поверх [`thread`] — см. `docs/ROADMAP.md`.
